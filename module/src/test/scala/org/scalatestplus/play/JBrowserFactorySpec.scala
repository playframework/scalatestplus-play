...
class JBrowserFactorySpec extends UnitSpec with GuiceOneServerPerSuite with OneBrowserPerSuite with JBrowserDriverFactory {
  ...
  "The JBrowserDriverFactory trait" must {
