...
class OneServerPerTestWithConfiguredBrowserSpec
    extends UnitSpec
  ...
  override def nestedSuites: Vector[OneServerPerTestWithConfiguredBrowserNestedSpec] =
    Vector(new OneServerPerTestWithConfiguredBrowserNestedSpec)
...
@DoNotDiscover
class OneServerPerTestWithConfiguredBrowserNestedSpec extends UnitSpec with ConfiguredServer with ConfiguredBrowser {
