...
class ConfiguredServerWithConfiguredBrowserSpec
    extends UnitSpec
  ...
  override def nestedSuites: Vector[ConfiguredServerWithConfiguredBrowserNestedSpec] =
    Vector(new ConfiguredServerWithConfiguredBrowserNestedSpec)
