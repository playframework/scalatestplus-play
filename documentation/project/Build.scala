...
object ApplicationBuild extends Build {
  ...
  val codeFilter = new ExactFilter("code")

  lazy val main = Project("ScalaTest-Play-Documentation", file("."))
    .enablePlugins(PlayDocsPlugin).settings(
    ...
    ProjectRef(Path.fileProperty("user.dir").getParentFile / "module", "ScalaTestPlusPlay") % "test"
  )
